...
router.get('/', function (req, res, next) {
    connection.query('SELECT cm.id,cm.fecha, cm.id_paciente, mas.nombre, med.nombre, med.apellido, med.consultorio FROM cita_medica cm, pacientes mas, medicos med WHERE cm.id_paciente = mas.cedula AND cm.id_medico= med.cedula', (error, results) => {
        if (error) {
